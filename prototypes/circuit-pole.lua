...
overwriteContent(circuitPole, {
	name = "circuit-pole",
	icon = "__integratedCircuitryFixed__/graphics/icons/circuit-pole.png",
	icon_size = 32,
...
circuitPole.radius_visualisation_picture.filename = "__integratedCircuitryFixed__/graphics/entity/circuit-pole-radius-visualization.png",
data:extend({	circuitPole })
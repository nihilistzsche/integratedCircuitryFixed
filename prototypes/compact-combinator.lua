...
overwriteContent(item, {
	...
	icon = "__integratedCircuitryFixed__/graphics/icons/compact-combinator.png",
	icon_size = 32,
})
data:extend({	item })
...
overwriteContent(entity, {
  ...
  selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
	inventory_size = 0,
	sprites = {
		filename = "__integratedCircuitryFixed__/graphics/entity/compact-combinator.png",
		priority = "extra-high",
		width = 120,
		height = 120,
...
overwriteContent(entity, {
	...
	selection_box = _NIL_,
	picture = {
		filename = "__integratedCircuitryFixed__/graphics/empty4x1.png",
		priority = "extra-high",
		width = 1,
		height = 1,
		direction_count = 1,
...
overwriteContent(entity, {
  ...
  selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
	...
	pictures = {
		filename = "__integratedCircuitryFixed__/graphics/entity/compact-combinator-port.png",
		priority = "extra-high",
		width = 52,
		height = 40,
		direction_count = 1,
